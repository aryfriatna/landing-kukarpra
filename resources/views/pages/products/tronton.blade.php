...
@section('title', 'Products-Tronton')
...
@section('content')
    ...
    <section class="relative pt-24 pb-16 bg-blue-900 text-white">
        <div class="container mx-auto px-4">
            <nav class="flex items-center space-x-1">
                ...
                <span class="text-white">/</span>
                <span class="text-white">Tronton</span>
            </nav>
        </div>
        <div class="container mx-auto px-4 pt-12">
            <div class="max-w-3xl">
                <h1 class="text-4xl md:text-5xl font-bold mb-4">Ban Tronton</h1>
                <p class="text-xl text-gray-300 mb-6">
                    Ban Tronton dan Trailer – Stabil, Kuat, dan Tahan Beban Berat
                </p>
    ...
    <section class="py-16 bg-gray-50">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold mb-8 text-center">Ban Tronton</h2>
            <p class="text-gray-600 mb-12 md:text-center text-justify flex justify-center">
                Mengangkut muatan besar dan berat membutuhkan ban yang tak sekadar kuat, tapi juga stabil dan tahan lama.
                Kami menyediakan ban tronton dan trailer dengan load index tinggi, grip optimal, serta sidewall yang
                diperkuat untuk memastikan keamanan saat distribusi barang besar atau berat di jalur darat.
            </p>
